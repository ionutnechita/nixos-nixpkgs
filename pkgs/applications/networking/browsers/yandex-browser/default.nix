...
let
  version = {
    ...
    beta = "24.7.6.1043-1";
    stable = "24.7.6.1042-1";
  }.${edition};

  hash = {
    corporate = "sha256-vI38b1j1eljcfBAZ6R2M9MR0I2XZj7dm98MBrcZPwE0=";
    beta = "sha256-JMJwZlVr5ZIJMgvDpAMqDTqmN/QE0Dlje/MkPcC9F08=";
    stable = "sha256-mQLqsEmOaN5ClXwq5ufOx+AX8DZWO7KbU6iAEqfG+1U=";
  }.${edition};
